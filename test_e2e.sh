...
# ==========================================
echo -e "\n${YELLOW}▶️  TEST 1: Standard E2E Push, Pull, and Integrity${NC}"
...
# ==========================================
echo -e "\n${YELLOW}▶️  TEST 2: Atomic Download Limits (--max-views 1)${NC}"
...
# ==========================================
echo -e "\n${YELLOW}▶️  TEST 3: CAS Deduplication & Garbage Collection${NC}"
